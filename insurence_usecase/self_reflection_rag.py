...
facts. \n Give a binary score 'yes' or 'no'. 'Yes' means that the answer is grounded in / supported by the set of 
facts."""
...
# Run
inputs = {"question": "How much is being paid as professional fees?"}
...
inputs = {"question": "Who are the defined professionals ?"}
for output in app.stream(inputs):
    for key, value in output.items():
        # Node
        pprint(f"Node '{key}':")
